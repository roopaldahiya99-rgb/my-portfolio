  ...
  thesis: [
    {
      ...
      takeaway: "<strong>Thesis:</strong> Climate tech isn't charity — it's the biggest market transition of the century. I focus on companies that collapse the 'green premium' through technology and business model innovation.",
    ...
    },
    {
      ...
      takeaway: "<strong>Thesis:</strong> The best fintech companies in emerging markets don't compete with banks — they route around them entirely, leveraging mobile penetration, agent networks, and data.",
    ...
    },
    {
      ...
      takeaway: "<strong>Thesis:</strong> My focus is on access, not luxury healthcare — affordable diagnostics, last-mile distribution, and telemedicine designed for low-bandwidth environments.",
    ...
    },
    {
      ...
      takeaway: "<strong>Thesis:</strong> The best insurtech companies use behavioural data and parametric triggers to price risk that legacy actuarial tables can't see — especially for the gig economy.",
    ...
    },
    {
      ...
      takeaway: "<strong>Thesis:</strong> Local and regional news media is critical infrastructure — tech-enabled business models can make quality journalism economically viable.",
    ...
    },
    {
      ...
      takeaway: "<strong>Thesis:</strong> I focus on the infrastructure layer — storage, grid modernisation, and distributed energy — where defensible businesses with long asset lives are being built.",
