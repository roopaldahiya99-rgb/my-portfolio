  ...
  timeline: [
    {
      ...
      title: "Editor & Writer",
      detail: "This is where I learned how to write well. I was Editor in Chief in college and reviewed 50+ writing pieces.",
      icon: "✍️",
    },
    {
      era: "Startup Compass",
      title: "Co-Author",
      detail: "Interviewed unicorn founders about building from zero — turned their stories into a book that taught me how to make complex ideas simple.",
      icon: "📖",
    },
    {
      era: "Google News Initiative",
      title: "Media & Innovation",
      detail: "Identified emerging innovations across India's news ecosystem, building a proprietary pipeline that guided $20MM in Google News investments.",
      icon: "🔍",
    },
    {
      era: "Dalberg Advisors",
      title: "Global Advisory",
      detail: "Advised clients like Shell, the US Embassy, and government ministers across geographies — led a cross-border acquisition that unlocked $15MM in revenue.",
      icon: "🌏",
      logo: "assets/logos/dalberg.png",
    },
    {
      era: "USAID Cambodia",
      title: "Climate-Tech Investing",
      detail: "Evaluated 20 climate-tech opportunities and guided $30M in capital deployment across 7 partner organisations.",
      icon: "🌱",
    },
    {
      era: "Solo Travel & Communities",
      title: "26+ Cities in One Year",
      detail: "Traveled solo across South and Southeast Asia, building networks and communities that bridge cultures and continents.",
      icon: "✈️",
    },
    {
      era: "KOIS Invest",
      title: "Early-Stage Investing",
      detail: "My first real exposure to venture investing — assessed 20+ healthcare ventures and managed 5 portfolio companies across South and Southeast Asia.",
      icon: "💡",
      logo: "assets/logos/kois.png",
    },
    {
      era: "Wysa",
      title: "AI Startup Operations",
      detail: "Built GTM strategy from scratch at a Bangalore-based AI mental health startup. Operating inside a startup changed how I invest forever.",
      icon: "🚀",
    ...
    },
    {
      era: "Rotman MBA",
      title: "Finance & CDL",
      detail: "Dean's List, $60K in awards, and deep-tech startup work through the Creative Destruction Lab. This is where frameworks became first principles.",
      icon: "🎓",
    ...
    },
    {
      ...
      detail: "Currently deploying capital into Canada's most promising ventures. Led DD on 7 deals, authored 4 memos with 100% IC approval.",
      icon: "💼",
      logo: "assets/logos/bdc.png",
    },
    {
      era: "The Future",
      title: "Leading My Own Fund",
      detail: "I see myself investing in world-changing, category-defining companies — and one day, leading my own fund.",
      icon: "🌟",
      isFuture: true,
    },
  ],
